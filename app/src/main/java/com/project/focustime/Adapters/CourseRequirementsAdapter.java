...
public class CourseRequirementsAdapter extends RecyclerView.Adapter<CourseRequirementsAdapter.ViewHolder> {
    ...
    private String mCourseRequirementsList;
    private Context mContext;
    public CourseRequirementsAdapter(Context context, String courseRequirements) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final String currentCourseOutcome = mCourseRequirementsList;
