...
public class LessonAdapter extends RecyclerView.Adapter<LessonAdapter.ViewHolder> {
    ...
    interface OnLessonClickListener {
        void onLessonClick(Lesson eachLesson, ViewHolder viewHolder);
        void onLessonCompletionListener(Lesson eachLesson, boolean lessonCompletionStatus);
    }

    private List<Lesson> mLesson;
    private Context mContext;
    private int lessonCounter = 0;
    public LessonAdapter(Context context, List<Lesson> lesson, OnLessonClickListener onLessonClickListener, boolean isFirst, int lessonFrom) {
        this.mLesson = lesson;
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, int position) {
        ...
        final Lesson currentLesson = mLesson.get(position);
