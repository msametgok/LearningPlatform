...
public class SectionAdapter extends RecyclerView.Adapter<SectionAdapter.ViewHolder> implements LessonAdapter.OnLessonClickListener {
    ...
    @Override
    public void onLessonClick(Lesson eachLesson, LessonAdapter.ViewHolder viewHolder) {
        mPassLessonToActivity.PassLesson(eachLesson, viewHolder);
    }

    @Override
    public void onLessonCompletionListener(Lesson eachLesson, boolean lessonCompletionStatus) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView, PassLessonToActivity passLessonToActivity) {
            super(itemView);
    ...
    private void setHeight(int numberOfItems, RecyclerView mRecyclerView) {
        int pixels = Helpers.convertDpToPixel((numberOfItems * 90) + 10);
    ...
    public interface PassLessonToActivity {
        void PassLesson(Lesson eachLesson, LessonAdapter.ViewHolder viewHolder);
        void ToggleLessonCompletionStatus(Lesson eachLesson, boolean lessonCompletionStatus);
    }
}
