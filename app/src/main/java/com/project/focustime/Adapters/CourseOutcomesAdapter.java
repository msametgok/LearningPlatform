...
public class CourseOutcomesAdapter extends RecyclerView.Adapter<CourseOutcomesAdapter.ViewHolder> {
    ...
    private String mCourseOutcomesList; // List<String> di şimdilik stringe çevirdim.Aynısını includes ve req.da da yaptım.
    private Context mContext;
    public CourseOutcomesAdapter(Context context, String courseOutcomes) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final String currentCourseOutcome = mCourseOutcomesList; //.get(posisiton) vardı sildim. Çünkü listi stringe çevirdim.Eğer tekrar list yaparsam burayı değiştir.
    ...
    //    return mCourseOutcomesList.size();
        return 1; // Hata vermesin diye ekledim. Sonradan sil.
    }
}
