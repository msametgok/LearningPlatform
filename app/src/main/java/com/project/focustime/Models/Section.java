...
public class Section {
    ...
    public Section(int id, String title, List<Lesson> lesson, int numberOfCompletedLessons, String totalDuration, int lessonCounterStarts, int lessonCounterEnds) {
        this.id = id;
        this.title = title;
        this.mLesson = lesson;
    ...
    public List<Lesson> getmLesson() {
        return mLesson;
    }

    public void setmLesson(List<Lesson> mLesson) {
